...
style.textContent =
  ...
  "#pomodoro-counter {color:white; font-size:max(5svmin, 1rem); align-self:start; white-space: nowrap; padding-inline: 8px;}" +
  "#pomodoro-counter {&:hover {cursor:pointer; opacity:0.5;}}" +
